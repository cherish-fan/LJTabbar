...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 文字颜色
        [self setTitleColor:LJTabBarButtonTitleColor forState:UIControlStateNormal];
        [self setTitleColor:LJTabBarButtonTitleSelectedColor forState:UIControlStateSelected];
